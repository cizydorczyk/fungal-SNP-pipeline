...
parser.add_argument('outfile', help='output FASTA file', type=str)
...
header = vcfTools2.VcfHeader(infile)
...
sys.stderr.write("FASTA output written to " + outfile + "\n")
